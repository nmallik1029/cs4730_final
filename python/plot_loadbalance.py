...
rows = list(csv.DictReader(open("results/loadbalance_results.csv")))
...
plt.tight_layout()
plt.savefig("figures/loadbalance_throughput.png", dpi=150)
print("wrote figures/loadbalance_throughput.png")
...
plt.tight_layout()
plt.savefig("figures/loadbalance_latency.png", dpi=150)
print("wrote figures/loadbalance_latency.png")
